    ...
    theme: {
        extend: {
            colors: {
                ...
                'brand-primary': '#4A592E', // teal (left gradient)
                'brand-primary-2': '#1A1A1A', // teal-light (right gradient)
                'brand-accent': '#6B6B6B', // amber accent
                'brand-light': '#F8F8F8', // page background
            },
            fontFamily: {
